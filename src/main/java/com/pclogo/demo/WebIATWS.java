...
public class WebIATWS extends WebSocketListener {
	...
	private static final String appid = "5ff5b321"; //在控制台-我的应用获取
	private static final String apiSecret = "193ce35e8a3acc215e76b22fd0f4c35e"; //在控制台-我的应用-语音听写（流式版）获取
	private static final String apiKey = "acce6b4976573ed1efadc8d4e1b2eba7"; //在控制台-我的应用-语音听写（流式版）获取
    private static final String file = "D:\\idea\\projects\\BackEnd\\src\\main\\java\\com\\pclogo\\demo\\16k_10.pcm"; // 中文
